 ...
 */
final class Version20200713124056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD CONSTRAINT FK_1D1C63B3613FECDF FOREIGN KEY (session_id) REFERENCES utilisateur (id)');
