 ...
 */
final class Version20200721121356 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE quiz_image (id INT AUTO_INCREMENT NOT NULL, image VARCHAR(255) NOT NULL, reponse_image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE question RENAME INDEX fk_b6f7494ece07e8ff TO IDX_B6F7494ECE07E8FF');
        $this->addSql('ALTER TABLE reponse_utilisateur CHANGE utilisateur_id utilisateur_id INT DEFAULT NULL, CHANGE anonyme_id anonyme_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE quiz_image');
