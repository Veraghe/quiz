 ...
 */
final class Version20200728065351 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reponse_utilisateur ADD reponse_textarea LONGTEXT DEFAULT NULL, CHANGE reponse_id reponse_id INT DEFAULT NULL, CHANGE utilisateur_id utilisateur_id INT DEFAULT NULL, CHANGE question_id question_id INT DEFAULT NULL, CHANGE anonyme_id anonyme_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT NULL, CHANGE image image INT DEFAULT NULL, CHANGE reponse_image reponse_image INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reponse_utilisateur DROP reponse_textarea, CHANGE reponse_id reponse_id INT DEFAULT NULL, CHANGE utilisateur_id utilisateur_id INT DEFAULT NULL, CHANGE question_id question_id INT DEFAULT NULL, CHANGE anonyme_id anonyme_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT \'NULL\', CHANGE image image INT DEFAULT NULL, CHANGE reponse_image reponse_image INT DEFAULT NULL');
